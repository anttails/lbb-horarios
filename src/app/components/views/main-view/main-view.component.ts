...
import { NavigationStart, ActivatedRoute, Router, RouterModule, RouterOutlet } from '@angular/router';
import { IconProp } from '@fortawesome/fontawesome-svg-core';
import { faCheck, faPencil, faSearch, faSpinner, faCircleExclamation, faLocationDot, faRefresh, faLightbulb, faMoon } from '@fortawesome/free-solid-svg-icons';
import { NgbTooltip, NgbModal, NgbDateAdapter, NgbDateParserFormatter, NgbDatepickerI18n, NgbDatepickerModule, NgbTimeAdapter, NgbTimepicker, NgbTypeaheadModule } from '@ng-bootstrap/ng-bootstrap';
import { TranslateModule, TranslateService } from '@ngx-translate/core';
import { filter, map, OperatorFunction, Observable, debounceTime, distinctUntilChanged, tap, switchMap, of, catchError } from 'rxjs';
...
import { CustomAdapter, CustomDateParserFormatter } from '../../../classes/ngb-datepicker-adapters';
import { I18n, CustomDatepickerI18n } from '../../../classes/ngb-datepicker-pt';
